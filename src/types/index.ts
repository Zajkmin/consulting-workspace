...
export interface ScheduleBlock { id:string; taskId:string; date:string; startTime:string; endTime:string; source:"manual"|"suggested"; completed:boolean; completedAt?:string; outcome?:DailyTaskOutcome; revision?:string }
export interface WorkPreferences { dayStart:string; dayEnd:string; workingDays:number[]; focusBlockMinutes:number; revision?:string }
