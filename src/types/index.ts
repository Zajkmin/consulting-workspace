...
export interface DeliverableVersion { id:string; initiativeId:string; code:string; name:string; status:TaskStatus; owner:string; startDate:string; deadline:string; taskIds:string[]; validated?:boolean }
export interface Initiative { id:string; projectId:string; name:string; description?:string; successCriteria?:string; area:string; status:TaskStatus; owner:string; owners?:string[]; startDate:string; deadline:string; impact:"Alto"|"Medio"|"Bajo"; versionIds:string[] }
