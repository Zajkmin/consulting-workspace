...
export const sharePointSchema: readonly SharePointListSchema[] = [
  ...
  { name: "CW_Users", description: "Perfiles y permisos funcionales", columns: [title("User.name"), appId(), { ...text("Objeto Entra", "EntraObjectId", "identidad de autenticación futura", false, true), unique: true }, { ...text("Correo", "Email", "User.email", true, true), unique: true }, text("Iniciales", "Initials", "User.initials"), choice("Rol", "Role", "User.role", ["admin", "usuario"], true), bool("Gestiona usuarios", "ManageUsers", "compatibilidad"), bool("Gestiona proyectos", "ManageProjects", "compatibilidad"), bool("Gestiona agenda", "ManageSchedule", "User.permissions.manageSchedule"), ...[["Crear proyectos","CanCreateProjects","createProjects"],["Editar proyectos","CanEditProjects","editProjects"],["Eliminar proyectos","CanDeleteProjects","deleteProjects"],["Crear iniciativas","CanCreateInitiatives","createInitiatives"],["Editar iniciativas","CanEditInitiatives","editInitiatives"],["Eliminar iniciativas","CanDeleteInitiatives","deleteInitiatives"],["Crear versiones","CanCreateVersions","createVersions"],["Editar versiones","CanEditVersions","editVersions"],["Eliminar versiones","CanDeleteVersions","deleteVersions"],["Crear tareas","CanCreateTasks","createTasks"],["Editar tareas","CanEditTasks","editTasks"],["Eliminar tareas","CanDeleteTasks","deleteTasks"],["Ver tareas ajenas","CanViewOthersTasks","viewOthersTasks"],["Crear usuarios","CanCreateUsers","createUsers"],["Editar usuarios","CanEditUsers","editUsers"],["Eliminar usuarios","CanDeleteUsers","deleteUsers"]].map(([label,name,property])=>bool(label,name,`User.permissions.${property}`)), bool("Activo", "IsActive", "User.active", true)] },
