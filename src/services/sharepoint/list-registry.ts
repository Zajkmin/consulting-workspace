...
export const sharePointLists: readonly SharePointListDefinition[] = [
  ...
  { key: "initiatives", name: "CW_Initiatives", env: "SHAREPOINT_INITIATIVES_LIST_ID", fields: ["Title", "AppId", "ProjectId", "AreaId", "Description", "SuccessCriteria", "Status", "OwnerUserId", "OwnerUserIds", "StartDate", "Deadline", "Impact"] },
  { key: "versions", name: "CW_Versions", env: "SHAREPOINT_VERSIONS_LIST_ID", fields: ["Title", "AppId", "InitiativeId", "Code", "Status", "OwnerUserId", "StartDate", "Deadline", "Validated"] },
