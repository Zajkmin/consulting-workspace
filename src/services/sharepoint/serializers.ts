...
export const listSerializers: { [K in SharePointEntityKey]: (entity: SharePointEntityByKey[K]) => Record<string, unknown> } = {
  ...
  initiatives: entity => ({ Title:entity.name,AppId:entity.id,ProjectId:entity.projectId,AreaId:entity.areaId,Description:entity.description??"",SuccessCriteria:entity.successCriteria??"",Status:entity.status,OwnerUserId:entity.ownerUserId,StartDate:entity.startDate,Deadline:entity.deadline||null,Impact:entity.impact }),
