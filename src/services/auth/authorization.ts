...
export function hasServerPermission(principal:ServerPrincipal, permission:ServerPermission):boolean { return principal.role === "admin" || principal.permissions[permission]; }
